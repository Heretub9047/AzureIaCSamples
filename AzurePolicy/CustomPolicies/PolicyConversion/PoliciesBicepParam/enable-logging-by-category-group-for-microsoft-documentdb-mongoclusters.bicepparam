...
param policydisplayName = 'Enable logging by category group for microsoft.documentdb/mongoclusters by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.documentdb/mongoclusters, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.documentdb/mongoclusters/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
