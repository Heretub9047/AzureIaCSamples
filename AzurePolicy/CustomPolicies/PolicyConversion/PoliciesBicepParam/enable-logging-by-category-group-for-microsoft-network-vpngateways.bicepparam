...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-network-vpngateways'

param policydisplayName = 'Enable logging by category group for microsoft.network/vpngateways by tags to Log Analytics'
