...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-connectedcache-enterprisemcccustomers'

param policydisplayName = 'Enable logging by category group for microsoft.connectedcache/enterprisemcccustomers by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.connectedcache/enterprisemcccustomers",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.connectedcache/enterprisemcccustomers, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.connectedcache/enterprisemcccustomers/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
