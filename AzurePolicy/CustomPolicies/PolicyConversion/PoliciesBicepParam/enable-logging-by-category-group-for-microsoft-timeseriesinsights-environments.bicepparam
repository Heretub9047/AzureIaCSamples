...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-timeseriesinsights-environments'

param policydisplayName = 'Enable logging by category group for microsoft.timeseriesinsights/environments by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.timeseriesinsights/environments, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
