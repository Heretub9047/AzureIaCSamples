...
param policyDefinitionName = 'enable-logging-by-category-group-for-network-managers'

param policydisplayName = 'Enable logging by category group for Network Managers (microsoft.network/networkmanagers) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.network/networkmanagers",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Network Managers (microsoft.network/networkmanagers), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.network/networkmanagers/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
