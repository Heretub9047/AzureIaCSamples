...
param policyDefinitionName = 'enable-logging-by-category-group-for-managed-databases'

param policydisplayName = 'Enable logging by category group for Managed databases (microsoft.sql/managedinstances/databases) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Managed databases (microsoft.sql/managedinstances/databases), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
