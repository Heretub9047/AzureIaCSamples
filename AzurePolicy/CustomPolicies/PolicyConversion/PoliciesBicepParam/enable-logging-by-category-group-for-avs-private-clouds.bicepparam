...
param policydisplayName = 'Enable logging by category group for AVS Private clouds (microsoft.avs/privateclouds) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type AVS Private clouds (microsoft.avs/privateclouds), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.avs/privateclouds/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
