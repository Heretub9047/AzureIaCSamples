...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-dbforpostgresql-servergroupsv2'

param policydisplayName = 'Enable logging by category group for microsoft.dbforpostgresql/servergroupsv2 by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.dbforpostgresql/servergroupsv2",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.dbforpostgresql/servergroupsv2, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.dbforpostgresql/servergroupsv2/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
