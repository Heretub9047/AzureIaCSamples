...
param policydisplayName = 'Enable logging by category group for Playwright Testing (microsoft.azureplaywrightservice/accounts) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.azureplaywrightservice/accounts",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Playwright Testing (microsoft.azureplaywrightservice/accounts), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.azureplaywrightservice/accounts/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
