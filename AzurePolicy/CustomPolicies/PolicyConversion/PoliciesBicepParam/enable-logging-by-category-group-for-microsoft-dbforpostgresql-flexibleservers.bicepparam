...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-dbforpostgresql-flexibleservers'

param policydisplayName = 'Enable logging by category group for microsoft.dbforpostgresql/flexibleservers by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.dbforpostgresql/flexibleservers, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
