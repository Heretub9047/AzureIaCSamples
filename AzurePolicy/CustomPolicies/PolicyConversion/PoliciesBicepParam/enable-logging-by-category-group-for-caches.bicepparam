...
param policydisplayName = 'Enable logging by category group for Caches (microsoft.cache/redisenterprise/databases) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.cache/redisenterprise/databases",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Caches (microsoft.cache/redisenterprise/databases), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.cache/redisenterprise/databases/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
