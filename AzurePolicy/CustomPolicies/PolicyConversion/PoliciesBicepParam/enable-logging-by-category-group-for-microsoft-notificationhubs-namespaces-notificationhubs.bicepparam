...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-notificationhubs-namespaces-notificationhubs'

param policydisplayName = 'Enable logging by category group for microsoft.notificationhubs/namespaces/notificationhubs by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.notificationhubs/namespaces/notificationhubs, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.notificationhubs/namespaces/notificationhubs/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
