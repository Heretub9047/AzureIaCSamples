...
param policydisplayName = 'Enable logging by category group for Connected Cache Resources (microsoft.connectedcache/ispcustomers) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.connectedcache/ispcustomers",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Connected Cache Resources (microsoft.connectedcache/ispcustomers), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.connectedcache/ispcustomers/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
