...
param policydisplayName = 'Enable logging by category group for microsoft.managednetworkfabric/networkdevices by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.managednetworkfabric/networkdevices",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.managednetworkfabric/networkdevices, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.managednetworkfabric/networkdevices/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
