...
param policydisplayName = 'Enable logging by category group for Managed CCF Apps (microsoft.confidentialledger/managedccfs) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.confidentialledger/managedccfs",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Managed CCF Apps (microsoft.confidentialledger/managedccfs), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.confidentialledger/managedccfs/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
