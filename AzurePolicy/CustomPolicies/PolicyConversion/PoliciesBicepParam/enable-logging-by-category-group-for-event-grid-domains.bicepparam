...
param policyDefinitionName = 'enable-logging-by-category-group-for-event-grid-domains'

param policydisplayName = 'Enable logging by category group for Event Grid Domains (microsoft.eventgrid/domains) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Event Grid Domains (microsoft.eventgrid/domains), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
