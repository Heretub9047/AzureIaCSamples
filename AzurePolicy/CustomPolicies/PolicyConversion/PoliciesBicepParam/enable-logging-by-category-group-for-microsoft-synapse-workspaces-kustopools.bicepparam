...
param policydisplayName = 'Enable logging by category group for microsoft.synapse/workspaces/kustopools by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.synapse/workspaces/kustopools, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.synapse/workspaces/kustopools/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
