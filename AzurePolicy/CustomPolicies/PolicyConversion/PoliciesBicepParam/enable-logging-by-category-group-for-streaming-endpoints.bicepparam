...
param policydisplayName = 'Enable logging by category group for Streaming Endpoints (microsoft.media/mediaservices/streamingendpoints) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.media/mediaservices/streamingendpoints",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Streaming Endpoints (microsoft.media/mediaservices/streamingendpoints), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.media/mediaservices/streamingendpoints/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
