...
param policyDefinitionName = 'enable-logging-by-category-group-for-application-insights'

param policydisplayName = 'Enable logging by category group for Application Insights (microsoft.insights/components) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Application Insights (microsoft.insights/components), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
