...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-networkcloud-storageappliances'

param policydisplayName = 'Enable logging by category group for microsoft.networkcloud/storageappliances by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.networkcloud/storageappliances",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.networkcloud/storageappliances, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.networkcloud/storageappliances/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
