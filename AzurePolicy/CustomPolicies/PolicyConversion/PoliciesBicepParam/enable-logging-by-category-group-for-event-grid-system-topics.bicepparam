...
param policyDefinitionName = 'enable-logging-by-category-group-for-event-grid-system-topics'

param policydisplayName = 'Enable logging by category group for Event Grid System Topics (microsoft.eventgrid/systemtopics) by tags to Log Analytics'
