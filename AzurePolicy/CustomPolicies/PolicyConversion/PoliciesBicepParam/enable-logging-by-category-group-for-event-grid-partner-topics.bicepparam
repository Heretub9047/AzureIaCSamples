...
param policyDefinitionName = 'enable-logging-by-category-group-for-event-grid-partner-topics'

param policydisplayName = 'Enable logging by category group for Event Grid Partner Topics (microsoft.eventgrid/partnertopics) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.eventgrid/partnertopics",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Event Grid Partner Topics (microsoft.eventgrid/partnertopics), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.eventgrid/partnertopics/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
