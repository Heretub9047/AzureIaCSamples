...
param policyDefinitionName = 'enable-logging-by-category-group-for-event-grid-topics'

param policydisplayName = 'Enable logging by category group for Event Grid Topics (microsoft.eventgrid/topics) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Event Grid Topics (microsoft.eventgrid/topics), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
