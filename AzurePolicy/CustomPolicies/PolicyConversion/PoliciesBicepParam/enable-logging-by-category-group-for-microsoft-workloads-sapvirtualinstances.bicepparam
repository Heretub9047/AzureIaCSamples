...
param policydisplayName = 'Enable logging by category group for microsoft.workloads/sapvirtualinstances by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.workloads/sapvirtualinstances, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.workloads/sapvirtualinstances/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
