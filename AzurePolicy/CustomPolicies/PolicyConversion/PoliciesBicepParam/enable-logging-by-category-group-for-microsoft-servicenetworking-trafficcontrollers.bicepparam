...
param policydisplayName = 'Enable logging by category group for microsoft.servicenetworking/trafficcontrollers by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.servicenetworking/trafficcontrollers",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.servicenetworking/trafficcontrollers, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.servicenetworking/trafficcontrollers/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
