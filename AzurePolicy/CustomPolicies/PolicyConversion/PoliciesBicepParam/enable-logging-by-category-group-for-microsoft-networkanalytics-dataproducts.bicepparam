...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-networkanalytics-dataproducts'

param policydisplayName = 'Enable logging by category group for microsoft.networkanalytics/dataproducts by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.networkanalytics/dataproducts",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.networkanalytics/dataproducts, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.networkanalytics/dataproducts/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
