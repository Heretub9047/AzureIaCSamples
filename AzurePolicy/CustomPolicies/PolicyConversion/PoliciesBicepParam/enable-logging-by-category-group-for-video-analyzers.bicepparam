...
param policydisplayName = 'Enable logging by category group for Video Analyzers (microsoft.media/videoanalyzers) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Video Analyzers (microsoft.media/videoanalyzers), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.media/videoanalyzers/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
