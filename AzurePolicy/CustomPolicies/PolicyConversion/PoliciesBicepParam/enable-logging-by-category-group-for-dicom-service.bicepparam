...
param policydisplayName = 'Enable logging by category group for DICOM service (microsoft.healthcareapis/workspaces/dicomservices) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type DICOM service (microsoft.healthcareapis/workspaces/dicomservices), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.healthcareapis/workspaces/dicomservices/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
