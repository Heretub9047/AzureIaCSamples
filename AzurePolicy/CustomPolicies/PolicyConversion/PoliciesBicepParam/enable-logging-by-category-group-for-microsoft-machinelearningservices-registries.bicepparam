...
param policydisplayName = 'Enable logging by category group for microsoft.machinelearningservices/registries by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.machinelearningservices/registries, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.machinelearningservices/registries/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
