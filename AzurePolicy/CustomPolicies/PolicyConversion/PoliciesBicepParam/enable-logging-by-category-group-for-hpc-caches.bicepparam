...
param policydisplayName = 'Enable logging by category group for HPC caches (microsoft.storagecache/caches) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type HPC caches (microsoft.storagecache/caches), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.storagecache/caches/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
