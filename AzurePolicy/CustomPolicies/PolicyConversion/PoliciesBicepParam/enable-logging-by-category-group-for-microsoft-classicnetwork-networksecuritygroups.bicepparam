...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-classicnetwork-networksecuritygroups'

param policydisplayName = 'Enable logging by category group for microsoft.classicnetwork/networksecuritygroups by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.classicnetwork/networksecuritygroups, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.classicnetwork/networksecuritygroups/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
