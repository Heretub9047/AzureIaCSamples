...
param policyDefinitionName = 'enable-logging-by-category-group-for-microsoft-network-networksecurityperimeters'

param policydisplayName = 'Enable logging by category group for microsoft.network/networksecurityperimeters by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.network/networksecurityperimeters, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.network/networksecurityperimeters/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
