...
param policydisplayName = 'Enable logging by category group for microsoft.timeseriesinsights/environments/eventsources by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.timeseriesinsights/environments/eventsources",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.timeseriesinsights/environments/eventsources, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.timeseriesinsights/environments/eventsources/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
