...
param policydisplayName = 'Enable logging by category group for Live events (microsoft.media/mediaservices/liveevents) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.media/mediaservices/liveevents",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Live events (microsoft.media/mediaservices/liveevents), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.media/mediaservices/liveevents/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
