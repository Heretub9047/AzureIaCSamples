...
param policydisplayName = 'Enable logging by category group for 1ES Hosted Pools (microsoft.cloudtest/hostedpools) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.cloudtest/hostedpools",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type 1ES Hosted Pools (microsoft.cloudtest/hostedpools), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.cloudtest/hostedpools/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
