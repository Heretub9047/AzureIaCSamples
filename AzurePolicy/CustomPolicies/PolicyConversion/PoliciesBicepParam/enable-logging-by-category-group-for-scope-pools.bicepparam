...
param policyDefinitionName = 'enable-logging-by-category-group-for-scope-pools'

param policydisplayName = 'Enable logging by category group for SCOPE pools (microsoft.synapse/workspaces/scopepools) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type SCOPE pools (microsoft.synapse/workspaces/scopepools), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
