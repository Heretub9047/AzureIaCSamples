...
param policydisplayName = 'Enable logging by category group for microsoft.networkfunction/azuretrafficcollectors by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.networkfunction/azuretrafficcollectors",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.networkfunction/azuretrafficcollectors, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.networkfunction/azuretrafficcollectors/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
