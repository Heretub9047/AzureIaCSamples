...
param policydisplayName = 'Enable logging by category group for microsoft.network/dnsresolverpolicies by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.network/dnsresolverpolicies, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.network/dnsresolverpolicies/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
