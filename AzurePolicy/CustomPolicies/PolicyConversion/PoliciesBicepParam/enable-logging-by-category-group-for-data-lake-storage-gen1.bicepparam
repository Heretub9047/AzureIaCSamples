...
param policyDefinitionName = 'enable-logging-by-category-group-for-data-lake-storage-gen1'

param policydisplayName = 'Enable logging by category group for Data Lake Storage Gen1 (microsoft.datalakestore/accounts) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Data Lake Storage Gen1 (microsoft.datalakestore/accounts), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
