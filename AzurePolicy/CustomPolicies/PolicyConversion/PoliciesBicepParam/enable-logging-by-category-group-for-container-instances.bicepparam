...
param policyDefinitionName = 'enable-logging-by-category-group-for-container-instances'

param policydisplayName = 'Enable logging by category group for Container instances (microsoft.containerinstance/containergroups) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Container instances (microsoft.containerinstance/containergroups), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
