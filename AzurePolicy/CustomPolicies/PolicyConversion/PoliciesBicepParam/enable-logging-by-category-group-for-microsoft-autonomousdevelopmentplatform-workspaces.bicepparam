...
param policydisplayName = 'Enable logging by category group for microsoft.autonomousdevelopmentplatform/workspaces by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.autonomousdevelopmentplatform/workspaces",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.autonomousdevelopmentplatform/workspaces, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.autonomousdevelopmentplatform/workspaces/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
