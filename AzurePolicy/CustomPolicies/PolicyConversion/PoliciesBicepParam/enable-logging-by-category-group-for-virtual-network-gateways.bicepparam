...
param policyDefinitionName = 'enable-logging-by-category-group-for-virtual-network-gateways'

param policydisplayName = 'Enable logging by category group for Virtual network gateways (microsoft.network/virtualnetworkgateways) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Virtual network gateways (microsoft.network/virtualnetworkgateways), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
