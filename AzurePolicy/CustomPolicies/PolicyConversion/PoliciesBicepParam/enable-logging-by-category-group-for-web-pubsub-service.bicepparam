...
param policydisplayName = 'Enable logging by category group for Web PubSub Service (microsoft.signalrservice/webpubsub) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Web PubSub Service (microsoft.signalrservice/webpubsub), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.signalrservice/webpubsub/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
