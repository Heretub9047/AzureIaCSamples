...
param policydisplayName = 'Enable logging by category group for microsoft.machinelearningservices/workspaces/onlineendpoints by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type microsoft.machinelearningservices/workspaces/onlineendpoints, resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.machinelearningservices/workspaces/onlineendpoints/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
