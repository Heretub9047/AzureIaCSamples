...
param policydisplayName = 'Enable logging by category group for Code Signing Accounts (microsoft.codesigning/codesigningaccounts) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.codesigning/codesigningaccounts",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Code Signing Accounts (microsoft.codesigning/codesigningaccounts), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.codesigning/codesigningaccounts/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
