...
param policydisplayName = 'Enable logging by category group for Storage movers (microsoft.storagemover/storagemovers) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.storagemover/storagemovers",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Storage movers (microsoft.storagemover/storagemovers), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.storagemover/storagemovers/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
