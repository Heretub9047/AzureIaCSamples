...
param policydisplayName = 'Enable logging by category group for Experiment Workspaces (microsoft.experimentation/experimentworkspaces) by tags to Log Analytics'
...
param policyRule = '''
{
  "if": {
    "allOf": [
      {
        "equals": "microsoft.experimentation/experimentworkspaces",
        "field": "type"
      },
      {
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Experiment Workspaces (microsoft.experimentation/experimentworkspaces), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
            ...
            "resources": [
              {
                ...
                "type": "microsoft.experimentation/experimentworkspaces/providers/diagnosticSettings"
              }
            ],
            "variables": {}
          }
