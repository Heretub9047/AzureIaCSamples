...
param policyDefinitionName = 'enable-logging-by-category-group-for-front-door-and-cdn-profiles-1'

param policydisplayName = 'Enable logging by category group for Front Door and CDN profiles (microsoft.cdn/profiles) by tags to Log Analytics'
        ...
        "properties": {
          ...
          "template": {
            ...
            "outputs": {
              "policy": {
                "type": "string",
                "value": "[concat('Diagnostic setting ', parameters('diagnosticSettingName'), ' for type Front Door and CDN profiles (microsoft.cdn/profiles), resourceName ', parameters('resourceName'), ' to Log Analytics ', parameters('logAnalytics'), ' configured')]"
              }
            },
            "parameters": {
              "categoryGroup": {
